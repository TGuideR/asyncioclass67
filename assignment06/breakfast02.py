...
async def main():
    ...
    fry_egg = asyncio.create_task(FryEggs(2))
    fry_bacon = asyncio.create_task(FryBacon())
    toast_bread = asyncio.create_task(ToastBread(2))
    await asyncio.gather(fry_egg, fry_bacon, toast_bread)
